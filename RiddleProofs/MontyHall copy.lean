...
-- Remove magic number helper lemmas - compute directly in main theorems

-- Main theorem proofs using direct computation
...
theorem monty_hall_stay_probability:
  ...
  -- Direct computation: (1/18) / (1/6) = (1/18) * 6 = 6/18 = 1/3
  rw [ennreal_div_eq]
  norm_cast
